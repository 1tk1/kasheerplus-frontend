        ...
        <div className="flex">
              ...
              <div className={`absolute inset-0 transition-all duration-500 ${
                ...
                <div className="h-full flex flex-col">
                  ...
                  <form onSubmit={handleSignup} className="flex-1 flex flex-col">
                    ...
                    {/* Google Sign Up Button (user provided) */}
                    <button type="button" className="w-full bg-white text-primary py-3 px-6 rounded-xl font-medium hover:bg-gray-50 transition-all duration-200 border border-border-light flex items-center justify-center space-x-2" style={{ marginTop: '1.5rem' }}>
          ...
          <div className="hidden lg:flex lg:w-1/2 auth-features-bg relative">
            ...
            <div className="relative z-10 flex flex-col justify-start items-center h-full p-12 pt-16">
              ...
              {/* Features Grid */}
              <div className="grid grid-cols-2 gap-6 w-full max-w-lg" style={{ marginBottom: '1.5rem' }}>
