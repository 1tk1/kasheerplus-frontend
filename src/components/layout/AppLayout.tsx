...
const AppLayout: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen bg-background ${darkMode ? 'dark' : ''}`}>
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-primary transform transition-transform duration-300 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static lg:inset-0`}>
        <div className="flex flex-col h-full">
          {/* Logo */}
          <div className="flex items-center justify-between h-16 px-6 border-b border-primary-hover">
          ...
          <div className="p-4 border-t border-primary-hover">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-gradient-accent rounded-full flex items-center justify-center">
                <User className="h-5 w-5 text-light" />
              </div>
      ...
      <div className="lg:pl-64">
        {/* Top Bar */}
        <div className="sticky top-0 z-40 bg-card-bg border-b border-border-light backdrop-blur-sm">
            ...
            <div className="flex-1 max-w-lg mx-4 lg:mx-8">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search..."
                  className="w-full pl-10 pr-4 py-2 bg-secondary-bg border border-border-light rounded-xl text-sm focus:ring-2 focus:ring-accent focus:border-accent transition-all"
                />
              </div>
            </div>
